...
namespace StoreFrontSchema.UI.MVC.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(StoreFrontSchemaContext context)
        {
            _context = context;
        }
        ...
        {
            var storeFrontSchemaContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Weapons, "ProductId", "ProductName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,ProductId,OrderId,Quantity,ProductPrice")] OrderProduct orderProduct)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Weapons, "ProductId", "ProductName", orderProduct.ProductId);
            return View(orderProduct);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StoreFrontSchemaContext.OrderProducts'  is null.");
            }
            var orderProduct = await _context.OrderProducts.FindAsync(id);
            if (orderProduct != null)
            {
