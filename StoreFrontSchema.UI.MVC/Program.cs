...
builder.Services.AddDbContext<StoreFrontSchemaContext>(options =>
    options.UseSqlServer(connectionString));
...
{
    options.IdleTimeout = TimeSpan.FromMinutes(20);//This is the duration a session is stored in memory.
